...
describe("MessageList", () => {
  ...
  it("renders one annotation for overlapping duplicate findings", () => {
    render(
      <MessageList
        {...defaultProps({
          messages: [makeMessage(), makeMessage(), makeMessage({ content: "Recovered" })],
          findings: [
            {
              type: "recovery",
              probability: 0.75,
    ...
    expect(screen.getAllByText("★ RECOVERY 78%")).toHaveLength(1);
  });
